...
# Toggle content filtering on/off. Set to False to disable prohibited-word checks.
ENABLE_CONTENT_FILTER = True

# Words or phrases that are not allowed in posted messages.
# Matching is case-insensitive and uses whole-word boundaries.
# Add items here or override via environment/config management if needed.
PROHIBITED_WORDS = {
    "2g1c",
    "2 girls 1 cup",
    "acrotomophilia",
    ...
    "zoophilia",
    "🖕",
    # Common non-sexual spam/abuse words
    "spam",
    "scam",
    "malware",
    "phish",
